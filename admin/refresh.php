         ...
         <div>
				...
				<tr>
				      <div class="input-group mb-3">
						...
						<td><SELECT NAME="state_name" id="state_name">
							<OPTION VALUE="select">selectionner
							<?php 
						...
						<td><input type="submit" name="Submit" value="Voir les Resultats" />
						</td>
					</div>
				</tr>
				</form> 
            ...
            <div style="    width: 50%;
               ...
               <img src="images/candidate-1.gif"
                  ...
                  height='20'>
               <?php if(isset($_POST['Submit'])){ if ($candidate_2 || $candidate_1 != 0){echo(100*round($candidate_1/($candidate_2+$candidate_1),2));}} ?>% (Total des Votes : <?php if(isset($_POST['Submit'])){echo $totalvotes;} ?> )
               <br>Le nombre des votes est <?php if(isset($_POST['Submit'])){ echo $candidate_1;} ?>
               <br>
               <br>
               ...
               <img src="images/candidate-2.gif"
                  ...
                  height='20'>
               <?php if(isset($_POST['Submit'])){ if ($candidate_2 || $candidate_1 != 0){echo(100*round($candidate_2/($candidate_2+$candidate_1),2));}} ?>% (Total des Votes : <?php if(isset($_POST['Submit'])){echo $totalvotes;} ?> )
               <br>Le nombre des votes est<?php if(isset($_POST['Submit'])){ echo $candidate_2;} ?>
            </div>
         </div>
      </div>
   </body>
